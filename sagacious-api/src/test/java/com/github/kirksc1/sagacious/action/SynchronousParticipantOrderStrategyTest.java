...
public class SynchronousParticipantOrderStrategyTest {
    ...
    public void testConstructor_whenNullRepository_thenThrowIllegalArgumentException() {
        ...
        new SynchronousParticipantOrderStrategy(null, manager, objectMapper);
    }
    ...
    public void testConstructor_whenNullManager_thenThrowIllegalArgumentException() {
        ...
        new SynchronousParticipantOrderStrategy(repository, null, objectMapper);
    }
    ...
    public void testConstructor_whenNullObjectMapper_thenThrowIllegalArgumentException() {
        ...
        new SynchronousParticipantOrderStrategy(repository, manager, null);
    }
}
