...
@DataJpaTest
public class SynchronousParticipantOrderStrategyIntegrationTest {
    ...
    @Test
    public void testPerformCompensatingActions_whenExecuted_thenParticipantsAreExecutedInOrder() {
        ...
        assertEquals("1", executor.getUris().get(0));
        assertEquals("2", executor.getUris().get(1));
